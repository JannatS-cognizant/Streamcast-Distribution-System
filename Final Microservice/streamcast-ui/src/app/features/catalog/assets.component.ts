      ...
      <div class="sc-card overflow-hidden" *ngIf="titleId()">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr *ngFor="let a of rows()" class="border-b border-border hover:bg-surface-3 transition">
        ...
        <div *ngIf="!loading() && rows().length === 0" class="py-10 text-center text-ink-300">No assets for this title.</div>
      </div>
